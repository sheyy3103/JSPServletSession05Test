...
<body>
	<div class="container">
		<h1 class="text-danger text-uppercase py-3">Edit "${c.companyName }"</h1>
		<div class="row">
			<div class="col-8">
				<form action="Update" method="post">
					<div class="form-group">
						<input type="hidden" class="form-control rounded-pill"
							name="companyId" value="${c.companyId }">
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Company name:</label> <input
							type="text" class="form-control rounded-pill" name="companyName"
							value="${c.companyName }"> <small id="emailHelp"
							class="form-text text-danger">${companyNameErr }</small>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Address:</label> <input
							type="text" class="form-control rounded-pill" name="address"
							value="${c.address }"> <small id="emailHelp"
							class="form-text text-danger">${addressErr }</small>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Director:</label> <input
							type="text" class="form-control rounded-pill" name="director"
							value="${c.director }"> <small id="emailHelp"
							class="form-text text-danger">${directorErr }</small>
					</div>

					<div class="form-group">
						<label for="exampleInputPassword1">Inauguration day:</label> <input
							type="date" class="form-control rounded-pill"
							name="inaugurationDay" value="${c.inaugurationDay }"> <small id="emailHelp"
							class="form-text text-danger">${inaugurationDayErr }</small>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Field of activity:</label> <input
							type="text" class="form-control rounded-pill"
							name="fieldOfActivity" value="${c.fieldOfActivity }"> <small id="emailHelp"
							class="form-text text-danger">${fieldOfActivityErr }</small>
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">Total employees:</label> <input
							type="text" class="form-control rounded-pill"
							name="totalEmployees" value="${c.totalEmployees }"> <small id="emailHelp"
							class="form-text text-danger">${totalEmployeesErr }</small>
					</div>
					<div class="form-group">
